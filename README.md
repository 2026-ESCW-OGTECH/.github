...
- [PLAN.md](PLAN.md): 작품 정의, P0 범위, 일정
- [AGENTS.md](AGENTS.md): 안전 계약과 에이전트 작업 규칙
- [GitHub 운영 절차](docs/GITHUB_OPERATIONS.md): 브랜치, PR, 공개 전환 점검
- [안전 계약 원본](docs/AI_AGENT_GUIDE.md)

조직 프로필은 [`profile/README.md`](profile/README.md)입니다. 이 루트 README와 혼동하거나 덮어쓰지 않습니다.
