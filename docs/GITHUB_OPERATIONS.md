...
- `main`에 직접 push하지 않습니다. 작업 브랜치와 draft PR을 사용합니다.
...
루트 README를 만들거나 고칠 때 `profile/README.md`를 덮어쓰지 않습니다. 루트 README는 공통 문서 보관소라는 짧은 설명과 `PLAN.md`, `AGENTS.md`, 이 문서 링크만 두면 충분합니다.
